...
export const metadata: Metadata = {
  title: "Anahtar Teslim Ev Tadilatı | Nivora — Ankara",
  description:
    "Ankara'da anahtar teslim daire ve ev tadilatı. Elektrik, sıhhi tesisat, alçı, boyama, zemin ve tavan dahil eksiksiz yenileme. Yazılı teklif, 1 yıl işçilik garantisi.",
};

const WHATSAPP_URL = "https://wa.me/905321234567";

const yapilanIsler = [
  { title: "Elektrik Tesisatı", desc: "Yeni kablo döşeme, pano yenileme, aydınlatma noktaları ve priz yerleşimi." },
  { title: "Sıhhi Tesisat", desc: "Su ve atık su boruları, vana değişimi, banyo ve mutfak bağlantıları." },
  { title: "Alçı & Saten", desc: "Duvar düzeltme, saten alçı, asma tavan ve kartonpiyer uygulamaları." },
  { title: "Boyama", desc: "Hazırlık, astar ve son kat boya. Özel efekt ve duvar kağıdı seçenekleri." },
  { title: "Zemin Kaplama", desc: "Laminat, parke, seramik veya vinil — mekâna ve bütçeye göre seçim." },
  { title: "Kapı & Donanım", desc: "İç kapı değişimi, menteşe ve kilit yenileme, pervaz ve süpürgelik montajı." },
];

const sure = [
  { step: "01", title: "Ücretsiz Keşif", desc: "Yerinde ölçüm ve tespitle proje kapsamı belirlenir." },
  { step: "02", title: "Yazılı Teklif", desc: "Detaylı, şeffaf fiyatlandırma. Sürpriz maliyet yok." },
  { step: "03", title: "Sözleşme", desc: "Kapsam, süre ve ödeme planı yazılı olarak onaylanır." },
  { step: "04", title: "Uygulama", desc: "Planlı ilerleme, günlük güncelleme, temiz çalışma alanı." },
  { step: "05", title: "Teslim", desc: "Son kontrol yapılır, sözleşme kapsamındaki tüm işler eksiksiz teslim edilir." },
];

export default function AnahtarTeslimPage() {
  const kompleProjects = projects.filter(
    (p) => p.category === "Komple Tadilat"
  );

  return (
    <>
      <PageHero
        label="Hizmetler / Anahtar Teslim Tadilat"
        title="Anahtar Teslim Ev Tadilatı"
        subtitle="Dairenizin tüm odalarını baştan sona yeniliyoruz. Elektrik, tesisat, alçı, boya ve zeminden kapı donanımına kadar her şey tek elden."
        image="/images/services/anahtar-teslim-ev-tadilati.png"
        imageAlt="Anahtar teslim ev tadilatı"
      />
      ...
      <section className="bg-antrasit py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid lg:grid-cols-3 gap-8">
            {[
              {
                title: "Sertifikalı Malzeme",
                desc: "Yalnızca belgeli ve garanti kapsamındaki malzemeler kullanıyoruz.",
              },
              {
              ...
              },
              {
                ...
                desc: "Kapsam, süre ve maliyet baştan belirlenir. Sözleşme dışı talep yok.",
              },
            ].map((item) => (
      ...
      <section className="bg-white py-16 lg:py-20">
        <div className="max-w-3xl mx-auto px-6 lg:px-10 text-center">
          ...
          <p className="text-taupe font-sans text-sm lg:text-base leading-relaxed mb-8">
            Dairenizin mevcut durumunu değerlendirip size özel, şeffaf bir teklif
            sunuyoruz. Keşif ziyareti ücretsiz ve bağlayıcı değildir.
          </p>
          <a
            href={WHATSAPP_URL}
            target="_blank"
