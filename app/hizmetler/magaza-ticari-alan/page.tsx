...
export default function MagazaTicariAlanPage() {
  return (
    <>
      ...
      {/* ── 7. TAMAMLANAN TİCARİ İŞLERİMİZDEN ── */}
      <AnimatedSection>
        <section className="bg-antrasit py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-6 lg:px-10">
            <div className="mb-10">
              ...
              <h2 className="font-heading text-2xl lg:text-3xl font-bold text-white mb-4 leading-tight">
                Tamamlanan Ticari Alan İşlerimizden
              </h2>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 lg:gap-3 mb-12">
              <div className="relative h-48 lg:h-56 overflow-hidden bg-antrasit/60">
                <Image src="/images/Nivora-referans-gorseller/kafe-ici.jpeg" alt="Kafe iç mekan" fill className="object-cover" sizes="(max-width: 1024px) 50vw, 25vw" />
              </div>
              <div className="relative h-48 lg:h-56 overflow-hidden bg-antrasit/60">
                <Image src="/images/Nivora-referans-gorseller/kafe-ici-3.jpeg" alt="Kafe uygulama" fill className="object-cover" sizes="(max-width: 1024px) 50vw, 25vw" />
              </div>
              <div className="relative h-48 lg:h-56 overflow-hidden bg-antrasit/60">
