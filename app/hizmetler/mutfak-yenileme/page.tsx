...
import MutfakFAQ from "./MutfakFAQ";

export const metadata: Metadata = {
  title: "Ankara Mutfak Tadilatı ve Yenileme | Nivora",
  description:
    "Nivora, Ankara'da mutfak yenileme ve mutfak tadilatı hizmetlerinde estetik, kullanışlılık, temiz çalışma ve ince işçilikle hizmet verir.",
};

import { waUrl } from "@/data/contact";
const WHATSAPP_URL = waUrl("mutfak");
...
const hizmetler = [
  {
    ...
    desc: "Mekâna özel ölçülerde üretilen alt ve üst dolap sistemleri. Kapı tipi, renk ve iç düzenleme işlevselliğe göre planlanır.",
  },
  {
    icon: <CounterIcon />,
    title: "Tezgâh & Evye Uygulamaları",
    desc: "Granit, kuvars veya kompakt laminat tezgah; paslanmaz, granit veya porselen evye seçimi ve hassas montajı.",
  },
  {
    icon: <TileIcon />,
    title: "Seramik & Zemin Yenileme",
    desc: "Dayanıklı porselen veya seramik zemin kaplaması, mutfağa özel arka panel fayansı. Derz ve birleşimlerde ince işçilik.",
  },
  {
    icon: <PipeIcon />,
    title: "Su & Elektrik Tesisatı",
    desc: "Evye, bulaşık makinesi ve su arıtma bağlantıları; ankastre cihaz ve davlumbaz için gerekli elektrik düzenlemeleri.",
  },
  {
    icon: <LightIcon />,
    title: "Aydınlatma Planlaması",
    desc: "Tavan spotları, dolap altı LED şerit, ada veya tezgah üstü armatür. Her çalışma bölgesi için doğru ışık planı.",
  },
  {
    icon: <DetailIcon />,
    title: "Detay, Aksesuar ve İnce İşçilik",
    desc: "Sürme rayları, yumuşak kapanma menteşeler, çekmece organizatörleri ve ek küçük dokunuşlarla kullanım konforu.",
  },
];
...
const steps = [
  ...
  },
  {
    ...
    desc: "Mevcut mutfağın fotoğraf ve ölçülerini alıyoruz; kullanım alışkanlıklarınızı ve beklentilerinizi dinliyoruz.",
  },
  {
    n: "03",
    title: "Yerinde Keşif",
    desc: "Tesisat durumunu, mevcut altyapıyı ve alanı yerinde inceliyoruz. Sorunlu noktaları önceden tespit ediyoruz.",
  },
  {
    n: "04",
    title: "İhtiyaç & Kullanım Planı",
    desc: "Depolama düzeni, çalışma alanı yerleşimi ve öncelikli ihtiyaçlar belirleniyor. Hangi alanın ne işe yarayacağı netleşiyor.",
  },
  {
    n: "05",
    title: "Yazılı Teklif",
...
const paketler = [
  {
    ...
    desc: "Mevcut dolap ve tesisat korunarak görünüm yenilenir. Kapı değişimi, tezgah, zemin ve aksesuar güncelleme.",
    items: ["Dolap Kapısı Değişimi", "Tezgah Yenileme", "Zemin Kaplaması", "Aksesuar Montajı"],
    accent: false,
  },
  {
    subtitle: "Fiyat-Performans Çözüm",
    title: "Kapsamlı Dönüşüm",
    desc: "Dolap gövde değişimi dahil. Hem altyapı hem yüzey yenileniyor; uzun soluklu ve kullanışlı bir mutfak.",
    items: ["Yeni Dolap Sistemi", "Tezgah & Evye", "Tam Seramik Kaplama", "Aydınlatma"],
    accent: true,
  },
  {
    subtitle: "Premium Çözüm",
    title: "Anahtar Teslim",
    desc: "Tasarımdan teslime her detay planlanır. Ölçüye göre üretim, premium malzeme, tesisat dahil.",
    items: ["Ölçüye Üretim Dolap", "Premium Tezgah", "Tesisat Yenileme", "Ankastre Entegrasyon"],
    accent: false,
  },
];
...
const garantiler = [
  {
    ...
    desc: "Dolap ve tezgah mutfağınıza özgü ölçülerde üretilir. Tam oturum ve kusursuz birleşim sağlanır.",
    icon: <RulerIcon />,
  },
  {
          ...
          <div className="grid lg:grid-cols-2 min-h-[540px]">
            ...
            <div className="flex flex-col justify-center py-16 lg:py-24 lg:pr-16">
              <p className="text-xs uppercase tracking-[0.3em] text-gold mb-5 font-sans">
                Hizmetler / Mutfak Yenileme
              </p>
              <h1 className="font-heading text-3xl lg:text-5xl font-bold text-white leading-tight mb-6">
                Ankara Mutfak Tadilatı ve Yenileme
              </h1>
              <p className="text-white/60 font-sans text-base leading-relaxed max-w-md mb-8">
                Nivora, mutfağınızı estetik, kullanışlı ve uzun ömürlü bir
                yaşam alanına dönüştürmek için temiz çalışma, kaliteli malzeme
                ve ince işçilikle hizmet verir.
              </p>
            ...
            <div className="relative hidden lg:block">
              <div className="absolute inset-0">
                <Image
                  src="/images/hero/mutfak-yenileme-hero.png"
                  alt="Ankara mutfak tadilatı ve yenileme"
                  fill
                  priority
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-10">
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-14">
              ...
              <p className="text-sm text-taupe font-sans max-w-xs leading-relaxed lg:text-right">
                Kısmî veya komple — her ihtiyaca özel çözüm üretiyoruz.
              </p>
            </div>
        ...
        <section className="bg-krem py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-6 lg:px-10">
            <div className="text-center mb-5">
              ...
              <h2 className="font-heading text-3xl lg:text-4xl font-bold text-antrasit mb-4">
                Mutfakta İyi Tasarım, Günlük Kullanımda Belli Olur
              </h2>
            ...
            <p className="text-sm text-taupe font-sans leading-relaxed max-w-2xl mx-auto text-center mt-8 mb-14">
              Mutfak tadilatında sadece güzel görünüm değil; depolama düzeni,
              tezgâh kullanımı, aydınlatma, zemin dayanıklılığı, tesisat
              altyapısı ve malzeme uyumu da önemlidir. Bu yüzden mutfağı hem
              estetik hem de kullanışlı bir alan olarak ele alırız.
            </p>
              ...
              {paketler.map((p) => (
                <div
                  ...
                  className={`relative p-8 ${
                    p.accent ? "bg-antrasit" : "bg-white border border-bej"
                  }`}
                >
                  {p.accent && (
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div>
                ...
                <p className="text-white/55 font-sans text-sm leading-relaxed max-w-md">
                  Mutfağınızın mevcut durumunu bize WhatsApp üzerinden gönderin.
                  Kullanım ihtiyacınızı, malzeme beklentinizi ve bütçenizi
...
function CabinetIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      ...
      <line x1="12" y1="7" x2="12.01" y2="7" strokeLinecap="round" strokeWidth="2.5" />
...
function CounterIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      ...
      <path d="M4 10v8M20 10v8M4 18h16" />
...
function RulerIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      <path d="M2 12.5L12.5 2l9.5 9.5-10.5 10.5L2 12.5z" />
      <line x1="7" y1="12" x2="9" y2="10" />
      <line x1="10" y1="15" x2="12" y2="13" />
